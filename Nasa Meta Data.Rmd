...
We can see that we have the correct number of documents, atht this is pretty much 100% spare, meaning that almost all of the entries in this matrix are zero.  Each non-zero entry corresponds to a cetain word appearing in a certain document.
